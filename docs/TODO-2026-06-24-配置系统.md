...
## Phase 5：TUI 配置入口 ⏳ 待实现

### 计划任务

```text
1. /config              - 展示当前配置摘要
2. /config workflow     - 修改workflow配置
3. /config goal         - 修改goal配置
4. /config models       - 修改模型配置
5. /config tools        - 修改工具策略
6. /config open         - 打开配置文件
7. /config reload       - 重新加载配置
```
...
```text
1. docs/configuration.md - 配置文档
2. deepreef config schema - 生成schema文档
3. deepreef config docs  - 生成配置文档
```

### 验收标准

```text
文档包含所有配置项的说明、类型、默认值、示例
```
