...
| 2 | `LSP-30` Manager 和文档同步，按 [ADVICE.md](ADVICE.md) 推进 | LSP-20 已完成，需实现 LspManager 和文档同步。 |
...
- LSP-10 和 LSP-20 已完成，基础模块就绪。
- 需要实现 LspManager 和文档同步。
...
下一步：优先执行 `OS-12/13-R` macOS/Windows 原生验收（需人工）；开发专项从 `LSP-30` 或 `PLG-10` 开始领取。
